...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TelstraMessaging.SendMmsRequestMMSContent = factory(root.TelstraMessaging.ApiClient);
  }
  ...
  /**
   * The SendMmsRequestMMSContent model module.
   * @module model/SendMmsRequestMMSContent
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>SendMmsRequestMMSContent</code>.
   * @alias module:model/SendMmsRequestMMSContent
   * @class
  ...
  /**
   * Constructs a <code>SendMmsRequestMMSContent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendMmsRequestMMSContent} obj Optional instance to populate.
   * @return {module:model/SendMmsRequestMMSContent} The populated <code>SendMmsRequestMMSContent</code> instance.
   */
