...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TelstraMessaging.OutboundPollResponseInner = factory(root.TelstraMessaging.ApiClient, root.TelstraMessaging.Status);
  }
  ...
  /**
   * The OutboundPollResponseInner model module.
   * @module model/OutboundPollResponseInner
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>OutboundPollResponseInner</code>.
   * @alias module:model/OutboundPollResponseInner
   * @class
   */
  ...
  /**
   * Constructs a <code>OutboundPollResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OutboundPollResponseInner} obj Optional instance to populate.
   * @return {module:model/OutboundPollResponseInner} The populated <code>OutboundPollResponseInner</code> instance.
   */
