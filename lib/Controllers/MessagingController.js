...
class MessagingController {
     ...
     * @returns {Promise}
     */
    static createSendSMS(payload, callback) {
                ...
                _request(_options, (_error, _response, _context) => {
                    ...
                    if (_error) {
                        ...
                        const mappedObject = _baseController.getObjectMapper()
                            .mapObject(response, 'ErrorErrorErrorErrorErrorException');
                        ...
                        const mappedObject = _baseController.getObjectMapper()
                            .mapObject(response, 'ErrorErrorErrorErrorErrorException');
                        mappedObject.reason = 'Authorization credentials passed and accepted but account does\nnot have permission';
                        mappedObject.context = _context;
                        const _err = { errorMessage: 'Authorization credentials passed and accepted but account does\nnot have permission',
                            errorCode: 403,
                            errorResponse: mappedObject };
                        _callback(_err, null, _context);
                        _reject(_err);
                        ...
                        const mappedObject = _baseController.getObjectMapper()
                            .mapObject(response, 'ErrorErrorErrorErrorErrorException');
                        mappedObject.reason = 'The request is formed correctly, but due to some condition\nthe request cannot be processed e.g. email is required and it is not provided\nin the request';
                        mappedObject.context = _context;
                        const _err = { errorMessage: 'The request is formed correctly, but due to some condition\nthe request cannot be processed e.g. email is required and it is not provided\nin the request',
                            errorCode: 422,
                            errorResponse: mappedObject };
                        _callback(_err, null, _context);
                        _reject(_err);
                        ...
                        const mappedObject = _baseController.getObjectMapper()
                            .mapObject(response, 'ErrorErrorErrorErrorErrorException');
                        mappedObject.reason = 'The HTTP method being used has not yet been implemented for\nthe requested resource';
                        mappedObject.context = _context;
                        const _err = { errorMessage: 'The HTTP method being used has not yet been implemented for\nthe requested resource',
                            errorCode: 501,
                            errorResponse: mappedObject };
                        _callback(_err, null, _context);
                        _reject(_err);
     ...
     * @returns {Promise}
     */
    static getSMSStatus(messageId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static retrieveSMSResponses(callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
