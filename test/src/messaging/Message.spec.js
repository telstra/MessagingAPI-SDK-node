...
describe('Message', () => {
    ...
    describe('send', () => {
        describe('when the client sends valid required attributes', () => {
            ...
            it('should pass when [multimedia] is an object with properties [type] and [payload] of type string', async () => {
                const data = {
                    to: ['+61234567890'],
                    multimedia: {
                        type: 'image/jpg',
        ...
        describe('when the client sends invalid optional attributes', () => {
            ...
            it('should fail and throw an assertion error when [subject] requires a string', async () => {
                const data = {
                    to: ['+61234567890'],
                    subject: 123,
                    multimedia: {
            ...
            it('should fail and throw an assertion error when [multimedia] requires to be an object', async () => {
                const data = {
                    to: ['+61234567890'],
                ...
                await expect(message.send(data)).rejects.toThrow(
                    new AssertionError({
                        errorCode: `MISSING_ATTRIBUTE`,
                        errorMessage: `data.multimedia should be object`,
                    })
                );
            });
            ...
            it('should fail and throw an assertion error as the [type] property of [multimedia] object is required field ', async () => {
                ...
                await expect(message.send(data)).rejects.toThrow(
                    new AssertionError({
                        errorCode: `MISSING_ATTRIBUTE`,
                        errorMessage: `data.multimedia should have required property 'type'`,
                    })
                );
            });

            it('should fail and throw an assertion error as the [type] property of [multimedia] object is required a be a string ', async () => {
                const data = {
                    to: ['+61234567890'],
                    multimedia: {
                        type: 123,
                ...
                await expect(message.send(data)).rejects.toThrow(
                    new AssertionError({
                        errorCode: `MISSING_ATTRIBUTE`,
                        errorMessage: `data.multimedia.type should be string, data.multimedia.type should be equal to one of the allowed values`,
                    })
                );
            });
            ...
            it('should fail and throw an assertion error as the [type] property of [multimedia] object is required a be a valid string ', async () => {
                ...
                await expect(message.send(data)).rejects.toThrow(
                    new AssertionError({
                        errorCode: `MISSING_ATTRIBUTE`,
                        errorMessage: `data.multimedia.type should be equal to one of the allowed values`,
                    })
                );
            });
            ...
            it('should fail and throw an assertion error as the [payload] property of [multimedia] object is required field ', async () => {
                ...
                await expect(message.send(data)).rejects.toThrow(
                    new AssertionError({
                        errorCode: `MISSING_ATTRIBUTE`,
                        errorMessage: `data.multimedia should have required property 'payload'`,
                    })
                );
            });

            it('should fail and throw an assertion error as the [payload] property of [multimedia] object is required a be a string ', async () => {
                const data = {
                    to: ['+61234567890'],
                    multimedia: {
                        type: 'image/jpeg',
                ...
                await expect(message.send(data)).rejects.toThrow(
                    new AssertionError({
                        errorCode: `MISSING_ATTRIBUTE`,
                        errorMessage: `data.multimedia.payload should be string`,
                    })
                );
            });

            it('should fail and throw an assertion error as the [fileName] property of [multimedia] object is required a be a string ', async () => {
                const data = {
                    to: ['+61234567890'],
                    multimedia: {
                        type: 'image/gif',
                ...
                await expect(message.send(data)).rejects.toThrow(
                    new AssertionError({
                        errorCode: `MISSING_ATTRIBUTE`,
                        errorMessage: `data.multimedia.fileName should be string`,
                    })
                );
            });
        });
