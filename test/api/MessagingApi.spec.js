...
(function(root, factory) {
  ...
  describe('MessagingApi', function() {
    ...
    describe('retrieveSMSResponses', function() {
      it('should call retrieveSMSResponses successfully', function(done) {
        //uncomment below and update the code to test retrieveSMSResponses
        //instance.retrieveSMSResponses(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
