...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessagingApi.InboundPollResponse();
  });
  ...
  describe('InboundPollResponse', function() {
    it('should create an instance of InboundPollResponse', function() {
      ...
      //var instane = new TelstraMessagingApi.InboundPollResponse();
      //expect(instance).to.be.a(TelstraMessagingApi.InboundPollResponse);
    });
