...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessagingApi.SendSMSRequest();
  });
  ...
  describe('SendSMSRequest', function() {
    it('should create an instance of SendSMSRequest', function() {
      ...
      //var instane = new TelstraMessagingApi.SendSMSRequest();
      //expect(instance).to.be.a(TelstraMessagingApi.SendSMSRequest);
    });
