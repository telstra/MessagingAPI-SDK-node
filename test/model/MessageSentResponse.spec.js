...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessaging.MessageSentResponse();
  });
  ...
  describe('MessageSentResponse', function() {
    it('should create an instance of MessageSentResponse', function() {
      ...
      //var instane = new TelstraMessaging.MessageSentResponse();
      //expect(instance).to.be.a(TelstraMessaging.MessageSentResponse);
    });
    ...
    it('should have the property numberNationalDestinations (base name: "NumberNationalDestinations")', function() {
      // uncomment below and update the code to test the property numberNationalDestinations
      //var instane = new TelstraMessaging.MessageSentResponse();
      //expect(instance).to.be();
    });

    it('should have the property numberInternationalDestinations (base name: "NumberInternationalDestinations")', function() {
      // uncomment below and update the code to test the property numberInternationalDestinations
      //var instane = new TelstraMessaging.MessageSentResponse();
      //expect(instance).to.be();
    });
