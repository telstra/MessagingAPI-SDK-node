...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessagingApi.ProvisionNumberResponse();
  });
  ...
  describe('ProvisionNumberResponse', function() {
    it('should create an instance of ProvisionNumberResponse', function() {
      // uncomment below and update the code to test ProvisionNumberResponse
      //var instane = new TelstraMessagingApi.ProvisionNumberResponse();
      //expect(instance).to.be.a(TelstraMessagingApi.ProvisionNumberResponse);
    });
