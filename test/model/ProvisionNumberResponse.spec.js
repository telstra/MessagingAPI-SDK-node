...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessaging.ProvisionNumberResponse();
  });
  ...
  describe('ProvisionNumberResponse', function() {
    it('should create an instance of ProvisionNumberResponse', function() {
      ...
      //var instane = new TelstraMessaging.ProvisionNumberResponse();
      //expect(instance).to.be.a(TelstraMessaging.ProvisionNumberResponse);
    });
