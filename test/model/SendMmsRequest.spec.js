...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessagingApi.SendMmsRequest();
  });
  ...
  describe('SendMmsRequest', function() {
    it('should create an instance of SendMmsRequest', function() {
      ...
      //var instane = new TelstraMessagingApi.SendMmsRequest();
      //expect(instance).to.be.a(TelstraMessagingApi.SendMmsRequest);
    });
