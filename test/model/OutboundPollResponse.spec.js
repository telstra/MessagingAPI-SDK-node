...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessagingApi.OutboundPollResponse();
  });
  ...
  describe('OutboundPollResponse', function() {
    it('should create an instance of OutboundPollResponse', function() {
      // uncomment below and update the code to test OutboundPollResponse
      //var instane = new TelstraMessagingApi.OutboundPollResponse();
      //expect(instance).to.be.a(TelstraMessagingApi.OutboundPollResponse);
    });
