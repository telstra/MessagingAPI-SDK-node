...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessaging.OAuthRequest();
  });
  ...
  describe('OAuthRequest', function() {
    it('should create an instance of OAuthRequest', function() {
      // uncomment below and update the code to test OAuthRequest
      //var instane = new TelstraMessaging.OAuthRequest();
      //expect(instance).to.be.a(TelstraMessaging.OAuthRequest);
    });
