...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessaging.HealthCheckResponse();
  });
  ...
  describe('HealthCheckResponse', function() {
    it('should create an instance of HealthCheckResponse', function() {
      ...
      //var instane = new TelstraMessaging.HealthCheckResponse();
      //expect(instance).to.be.a(TelstraMessaging.HealthCheckResponse);
    });
