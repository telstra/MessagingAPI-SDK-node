...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessagingApi.GetSubscriptionResponse();
  });
  ...
  describe('GetSubscriptionResponse', function() {
    it('should create an instance of GetSubscriptionResponse', function() {
      ...
      //var instane = new TelstraMessagingApi.GetSubscriptionResponse();
      //expect(instance).to.be.a(TelstraMessagingApi.GetSubscriptionResponse);
    });
