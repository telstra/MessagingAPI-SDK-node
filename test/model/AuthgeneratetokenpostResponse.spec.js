...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessaging.AuthgeneratetokenpostResponse();
  });
  ...
  describe('AuthgeneratetokenpostResponse', function() {
    it('should create an instance of AuthgeneratetokenpostResponse', function() {
      // uncomment below and update the code to test AuthgeneratetokenpostResponse
      //var instane = new TelstraMessaging.AuthgeneratetokenpostResponse();
      //expect(instance).to.be.a(TelstraMessaging.AuthgeneratetokenpostResponse);
    });
