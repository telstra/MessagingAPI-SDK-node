...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessagingApi.ProvisionNumberRequest();
  });
  ...
  describe('ProvisionNumberRequest', function() {
    it('should create an instance of ProvisionNumberRequest', function() {
      // uncomment below and update the code to test ProvisionNumberRequest
      //var instane = new TelstraMessagingApi.ProvisionNumberRequest();
      //expect(instance).to.be.a(TelstraMessagingApi.ProvisionNumberRequest);
    });
