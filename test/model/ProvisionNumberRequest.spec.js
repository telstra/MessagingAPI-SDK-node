...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessaging.ProvisionNumberRequest();
  });
  ...
  describe('ProvisionNumberRequest', function() {
    it('should create an instance of ProvisionNumberRequest', function() {
      ...
      //var instane = new TelstraMessaging.ProvisionNumberRequest();
      //expect(instance).to.be.a(TelstraMessaging.ProvisionNumberRequest);
    });
