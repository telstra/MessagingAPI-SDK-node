...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraMessagingApi.OAuthResponse();
  });
  ...
  describe('OAuthResponse', function() {
    it('should create an instance of OAuthResponse', function() {
      ...
      //var instane = new TelstraMessagingApi.OAuthResponse();
      //expect(instance).to.be.a(TelstraMessagingApi.OAuthResponse);
    });
